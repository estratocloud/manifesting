...
func GenerateManifest(environment *config.Environment, conf *config.Config, wd internal.WorkingDirectoryInterface, gd internal.GeneratedDirectoryInterface) error {
	...
	output := generation.NewGeneratedFile(environment.GetOutputPath(wd, gd))
