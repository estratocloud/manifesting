...
resources:
  - name: "basket"
    ...
    "templates": {
        "envvars.yaml": `- name: ACTIVE_FEATURE_FLAGS
  value: "2457"
...
Any references to names from the environments envvars will have the value included, and anything overridden will be left alone
