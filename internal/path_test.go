...
func wd(t *testing.T) WorkingDirectoryInterface {
...
func Test_Exists1(t *testing.T) {
	path := wd(t).NewPath("/app/internal/path_test.go")
	got, err := path.Exists()
	require.NoError(t, err)
...
func Test_Exists2(t *testing.T) {
	path := wd(t).NewPath("internal/path_test.go")
	got, err := path.Exists()
	require.NoError(t, err)
	assert.Equal(t, true, got)
}
...
func Test_Exists3(t *testing.T) {
	path := wd(t).NewPath("/app/internal/does-not-exist.go")
	got, err := path.Exists()
	require.NoError(t, err)
...
func Test_Exists4(t *testing.T) {
	path := wd(t).NewPath("internal/does-not-exist.go")
	got, err := path.Exists()
	require.NoError(t, err)
	assert.Equal(t, false, got)
}
...
func Test_Exists6(t *testing.T) {
	path := wd(t).NewPath("internal/bad-perms")
